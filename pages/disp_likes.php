            ...
            <div class="col-md-12">
              <div class="card  card-tasks">
                <div class="card-header ">
                  <h5 class="card-category">Liked Items:</h5>
                  <h4 class="card-title">
                    <?php 
                      if($resultcheck1 <= 0) {
                         echo "No Liked Items :(";
                          ...
                          if($resultcheck1 > 0) {
                              while($row1 = mysqli_fetch_assoc($result1)) { 
                                  ...
                                  if($resultcheck2 > 0) {
                                      ...
                                      echo "<tr><td class=\"text-left\"><a href=\"" . $row2['itemLink'] . 
                                      "\" target=_blank rel=noopener noreferrer>" . $row2['itemName'] . 
                                      " (SGD" . ($row2['itemPrice']) . ")</a></td>
                                      
                                      <td class=\"td-actions text-right\">
                                      <button 
                                      onclick=\"window.location.href='/OdinEye/pages/like.php?name=". $row2['itemName'] . "&price=" . ($row2['itemPrice']) . "&link=" . $row2['itemLink']  . "'\" 
