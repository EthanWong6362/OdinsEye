<?php
    ...
    $prices = array();
    if (isset($q)) {
        $lelongUrl = "https://www.lelong.com.my/catalog/all/list?TheKeyword=" . $q;
        $html2 = file_get_html($lelongUrl);
        foreach($html2->find('.summary a b') as $item) {
            array_push($items, $item->innertext);
            array_push($links, $item->attr['data-link']);
            array_push($prices, (float)($item->attr['data-price']) * 0.32);
        }
...
<html lang="en">
    ...
    <body>
        <div class="top"">
            ...
            <form action="lelong.php" method="POST" name="search" id="search" autocomplete="off">
        ...
        <div class="row">
            ...
            <div class="filter">
                ...
                <ul>
                    ...
                    <li><a href="flipkart.php">Flipkart</a></li>
                    <li>Lelong</li>
                </ul>
            </div>
